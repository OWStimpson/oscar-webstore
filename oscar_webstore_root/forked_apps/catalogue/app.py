...
from django.utils.six import get_method_function, get_method_self
from forked_apps import catalogue
...
class BaseCatalogueApplication(Application):
    ...
    def get_urls(self):
        ...
        urlpatterns += [
            ...
            # OS # Added mothed to handle ajax request to update the price and stock.
            url(r'^get_price_and_stock/$', 
                catalogue.views.get_price_and_stock, name='get_price_and_stock'), 
